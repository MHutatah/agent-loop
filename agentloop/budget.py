...
The loop shares one Claude subscription with your own interactive work, and
on a Pro plan that budget is small enough that an enthusiastic night of PR reviews
could leave him unable to use Claude in the morning. So judge calls are counted in
a rolling window and simply stop when the reserve is reached.
